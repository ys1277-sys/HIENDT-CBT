  ...
  "Level II/General/MT": [
...

    {
      ...
      o: [
        ...
        Q("can fill discontinuities, and particles cling where there is no discontinuity at all", "결함 입구를 막고, 결함이 없는 자리에도 자분이 묻어 있기 때문에"),
      ],
      a: 3,
      why: "기름·녹·스케일은 결함 입구를 막아 지시를 못 나오게 하고, 거꾸로 결함이 없는 자리에도 자분이 묻어 의사지시를 만든다. 어느 쪽이든 판독을 그르친다.",
    },
